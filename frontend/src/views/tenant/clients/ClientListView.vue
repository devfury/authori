...
function normalizeStatusFilter(value: unknown): string {
  return Object.values(ClientStatus).includes(value as ClientStatus) ? String(value) : ''
}
    ...
    <div class="mb-4 flex flex-col sm:flex-row gap-3">
      <div class="relative flex-1">
        ...
        <input
          v-model="searchInput"
          type="text"
          placeholder="이름 또는 Client ID로 검색"
      ...
      <div class="w-full sm:w-40 flex gap-2">
        ...
        >
          ...
          <option :value="ClientStatus.ACTIVE">활성</option>
          <option :value="ClientStatus.INACTIVE">비활성</option>
        </select>
        <button
          :disabled="loading"
