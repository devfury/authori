...
export class CreatePendingOAuthRequests1777100000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_pending_oauth_requests_expires_at"`);
