...
export class CreateRbacTables1775400000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_tenant_permissions_tenant_name"`);
    await queryRunner.query(`DROP TABLE "tenant_permissions"`);

    await queryRunner.query(`ALTER TABLE "tenant_roles" DROP CONSTRAINT "FK_tenant_roles_tenant"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_tenant_roles_tenant_name"`);
