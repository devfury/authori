...
export class InitialSchema1775023066112 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0047a332edda010ae29c24d0c1" ON "user_profiles" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'LOCKED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "oauth_client_redirect_uris" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "client_id" character varying NOT NULL, "uri" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_162e2f31eae5ca6e7e33dd7bdc6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."authorization_codes_code_challenge_method_enum" AS ENUM('S256', 'PLAIN')`,
    );
    await queryRunner.query(
      `CREATE TABLE "authorization_codes" ("code" character varying NOT NULL, "tenant_id" character varying NOT NULL, "client_id" character varying NOT NULL, "user_id" uuid NOT NULL, "redirect_uri" character varying NOT NULL, "scopes" text array NOT NULL, "code_challenge" character varying, "code_challenge_method" "public"."authorization_codes_code_challenge_method_enum", "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "used" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0dbddae21cb087717e5207a5bd1" PRIMARY KEY ("code"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_28772cc8c3cd0a9d22318e0780" ON "access_tokens" ("jti") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."admin_users_role_enum" AS ENUM('PLATFORM_ADMIN', 'TENANT_ADMIN')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."admin_users_status_enum" AS ENUM('ACTIVE', 'INACTIVE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tenant_settings" ADD CONSTRAINT "FK_a6abc1c3ed0df635955fc852f1c" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "profile_schema_versions" ADD CONSTRAINT "FK_ecf6de037a807c91243c03bf869" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_profiles" ADD CONSTRAINT "FK_df0ac090f9b68b8fd7ef0b775ba" FOREIGN KEY ("schema_version_id") REFERENCES "profile_schema_versions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "oauth_client_redirect_uris" ADD CONSTRAINT "FK_433d1e5d76dbb9a91f094828263" FOREIGN KEY ("client_id") REFERENCES "oauth_clients"("client_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "authorization_codes" ADD CONSTRAINT "FK_9b6780f6c2ce73987f7cabb4ae3" FOREIGN KEY ("client_id") REFERENCES "oauth_clients"("client_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "authorization_codes" ADD CONSTRAINT "FK_68f8ccfda6bb17fb159cc965cce" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_tokens" ADD CONSTRAINT "FK_45d8b3be92f43e7f01600443a19" FOREIGN KEY ("client_id") REFERENCES "oauth_clients"("client_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "refresh_tokens" ADD CONSTRAINT "FK_795771f59bffe508b60827b01eb" FOREIGN KEY ("client_id") REFERENCES "oauth_clients"("client_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "consents" ADD CONSTRAINT "FK_946390b9024aba22cd1c1621430" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "consents" ADD CONSTRAINT "FK_618e4fb7c4dc5b95a223cc9866c" FOREIGN KEY ("client_id") REFERENCES "oauth_clients"("client_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "oauth_clients" ADD CONSTRAINT "FK_74abff294e8ab96ed7e41c058c9" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "signing_keys" ADD CONSTRAINT "FK_4743a982b7bef0a8b4fa6c7003e" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "signing_keys" DROP CONSTRAINT "FK_4743a982b7bef0a8b4fa6c7003e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_6f18d459490bb48923b1f40bdb7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "oauth_clients" DROP CONSTRAINT "FK_74abff294e8ab96ed7e41c058c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "consents" DROP CONSTRAINT "FK_618e4fb7c4dc5b95a223cc9866c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "refresh_tokens" DROP CONSTRAINT "FK_795771f59bffe508b60827b01eb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_tokens" DROP CONSTRAINT "FK_09ee750a035b06e0c7f0704687e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_tokens" DROP CONSTRAINT "FK_45d8b3be92f43e7f01600443a19"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "oauth_client_redirect_uris" DROP CONSTRAINT "FK_433d1e5d76dbb9a91f094828263"`,
    );
    await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_109638590074998bb72a2f2cf08"`);
    await queryRunner.query(
      `ALTER TABLE "user_profiles" DROP CONSTRAINT "FK_df0ac090f9b68b8fd7ef0b775ba"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_profiles" DROP CONSTRAINT "FK_6ca9503d77ae39b4b5a6cc3ba88"`,
    );
    await queryRunner.query(
      `ALTER TABLE "profile_schema_versions" DROP CONSTRAINT "FK_ecf6de037a807c91243c03bf869"`,
    );
    await queryRunner.query(
