...
export class RbacController {
  ...
  async getRolePermissions(@Param('tenantId') tenantId: string, @Param('id') id: string) {
  ...
  setRolePermissions(
    ...
    return this.rbacService.setRolePermissions(tenantId, id, dto.permissionIds);
  }
  ...
  createPermission(@Param('tenantId') tenantId: string, @Body() dto: CreatePermissionDto) {
  ...
  removePermission(@Param('tenantId') tenantId: string, @Param('id') id: string) {
    return this.rbacService.removePermission(tenantId, id);
  }

  @Get('users/:userId/roles')
  @ApiOperation({ summary: '사용자 역할 조회' })
  findUserRoles(@Param('tenantId') tenantId: string, @Param('userId') userId: string) {
